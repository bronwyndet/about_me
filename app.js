...
document.getElementById('startGame').onclick = function runGame() {
  ...
  responseGreeting.textContent = 'Greetings, ' + userName + '! It\'s nice to meet you. Let\'s answer some questions about Bronwyn!';
  ...
  function questionOne() {
    ...
    if (answerOne.toLowerCase() === 'yes' || answerOne.toLowerCase() === 'y') {
      ...
      responseOne.textContent = 'You must not have noticed the photos! She does ride a motorcycle!';
    };
  }
  questionOne();
  ...
  function questionTwo() {
    ...
    if (answerTwo.toLowerCase() === 'yes' || answerTwo.toLowerCase() === 'y') {
      ...
      responseTwo.textContent = 'You must have missed the clues! She does have a daughter!';
    };
  }
  questionTwo();
  ...
  function questionThree() {
    ...
    if (answerThree.toLowerCase() === 'yes' || answerThree.toLowerCase() === 'y') {
      responseThree.textContent = 'So you recognized her favorite movie quote! Yes, she is a Browncoat!';
      score++;
    } else {
